...
export const PRE_BUILT_TITLE = i18n.translate(
  ...
  {
    defaultMessage: 'Install and enable 4C prebuilt detection rules',
  }
);
...
export const PRE_BUILT_MSG = i18n.translate(
  ...
  {
    defaultMessage:
      '4C Security comes with prebuilt detection rules that run in the background and create alerts when their conditions are met. To start using them, choose rules to install and enable.',
  }
);
